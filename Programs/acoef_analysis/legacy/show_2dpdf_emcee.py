...
def show_pdf_emcee(dir_mcmc='/Users/obenomar/tmp/test_a2AR/tmp/results_activity/gate_8379927_a2a4_fast/', file_out='plots', burnin=0, keep_positive=False, keep_epsilon=None, logepsilon=False):
