...
def bias_analysis(MCMCdir, combi_files, numax_star, fileout='bias', abs_err=False, saturate_colors=[False,''], filter_HNR=None, sigma_norm=False, text_index=None):
	'''
		Note on this version (v3): This version creates a bias map using arrows in the (a1/Gamma, inc) space and 
		...
		Inputs:
			MCMCdir: A list of main directory containing all of the data for all the scenario considered. It must be products of the IDL_postMCMC program
