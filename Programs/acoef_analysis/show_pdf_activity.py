...
def show_pdf_vpaper(dir_mcmc=None, names=[None], file_out='plots', burnin=0, do_inset=True, logepsilon=[False, False], xlim_epsilon=[[0, 1e-2],[0, 1e-2]], text_index=None, data_format=['emcee']):
	'''
