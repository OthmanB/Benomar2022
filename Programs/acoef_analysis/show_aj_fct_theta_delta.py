...
def grid_aj_mean(numax=None, Dnu=None, Mass=None, Radius=None, Teff=None, epsilon_nl=5*1e-4, a1=1000, dir_core='/Users/obenomar/Work/tmp/test_a2AR/', lmax=3):
	'''
...
def aj_mean_from_theta_delta(theta_star, delta_star, numax=2150., Dnu=103.11, a1=1000, epsilon_nl=5*1e-4, dir_core='/Users/obenomar/Work/tmp/test_a2AR/'):
	'''
...
def show_aj_fct_theta_delta(numax=2150., Dnu=103.11, a1=1000., epsilon_nl=5*1e-4, dir_core=None, file_out='aj_theta_delta', lmax=3):
	'''
