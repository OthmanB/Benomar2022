...
pro iterative_PostMCMC_MS_Global;, dir_outputs, dir_inputs
   ...
   dosavfilesonly=0 ; Default, you do everything from sav file until synthese files and plots 
    ...
    phase='L*'
    Nb_classes=100.;
    index0=400000. ; index of the first entry that is kept
    ...
    stop 
    for i=Ndirs-1, Ndirs-1 do begin ;Ndirs-1 do begin
...
function PostMCMC_MS_Global_v2, root_outputs, root_inputs, dir_out, modelname, starID, phase, Nb_classes, index0, keep_period, dosavfilesonly
	...
	;	stop
		...
		if modelname ne "model_MS_Global_aj_HarveyLike" then begin
			...
			print, 'Plots for correlations between a1,a2,a3,a4,a5,a6 inclination...'
			MS_Global_rotinc_correlations_aj, synthese_file, dir_IDL_out +'Files/', dir_IDL_out, starID
		endelse
...
pro show_split_inc_asym, dir_IDL_out, modelname, stat_synthese_unsorted, ind0_split, ind0_W, ind0_inc, Nmax
		...
		endif else begin ; The model 'model_MS_Global_aj_HarveyLike' has a structure that differ from old models
			split_names=['a1_0      ', 'a1_1      ', 'a2_0     ', 'a2_1     ', 'a3_0      ', 'a3_1     ', 'a4_0      ', 'a4_1     ', 'a5_0      ', 'a5_1     ', 'a6_0      ', 'a6_1     ', 'eta0_switch      ','asym      ']
		endelse
...
variable_name=strarr(4)
		...
		if pass eq 0 then begin ; Use the default if not recognized
