...
def show_diagram():
	fileout='/Users/obenomar/tmp/test_a2AR/tmp/External-data/Greenwich-data/butterfly.jpg'
	#file='/Users/obenomar/tmp/test_a2AR/tmp/External-data/Greenwich-data/daily_area.txt'
	file='/Users/obenomar/tmp/test_a2AR/tmp/External-data/Greenwich-data/butterflydata.txt' #-1985-2016.txt'
